...
public class CityMap extends Application {
    ...
    private void addEntities() {
        ...
        MSOEChallenge msoeChallenge = new MSOEChallenge(challengePane);
        MuseumChallenge museumChallenge = new MuseumChallenge(challengePane);
        BUSChallenge busChallenge = new BUSChallenge(challengePane);
        for(int i = 0; i < NUM_TOURISTS; i++) {
            ...
            car.addObserver(msoeChallenge);
            car.addObserver(busChallenge);
        }
        ...
        for (Museum museum: museums) {
            museum.addObserver(museumChallenge);
        }
